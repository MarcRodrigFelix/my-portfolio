...
function Projects() {
  return (
    <section id='projects' className="text-dark-red-brown bg-cyan-blue body-font">
            ...
            >
              <div className="flex relative">
                <img
                  src={project.image}
                  alt='project' 
                  className="absolute inset-0 w-full h-full object-cover object-center border-2 border-dark-red-brown" />
                <div className="px-8 py-10 relative z-10 w-full border-2 border-black bg-gray-900 opacity-0 hover:opacity-100">
